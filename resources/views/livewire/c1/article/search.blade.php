<div>
    <form>
        ...
        <button wire:click.prevent='clear()' @disabled(blank($searched)) class='p-2 text-white rounded-md bg-amber-600 disabled:bg-gray-400'>Clear</button>
    </form>
    ...
    <div>
        @foreach ($articles as $article)
            <div class="my-5 border-1 rounded-md p-5">
                ...
                <a class="hover:text-amber-600 cursor-pointer">
                    {{ $article->title }}
                </a>
                <p class="mt-5 pl-5">
